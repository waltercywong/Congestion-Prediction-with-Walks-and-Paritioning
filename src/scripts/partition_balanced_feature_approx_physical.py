...
def main():
    ...
    for design in tqdm(design_list, desc="Processing designs", position=0):
        ...
        part_dict_path = f"./data/superblue/superblue_{design}/balanced_feature_approx_physical_part_dict.pkl"
        mod_path = f"./data/superblue/superblue_{design}/balanced_feature_approx_physical_modularity.pkl"
